...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateTodo func(childComplexity int, input *codegen.CreateTodoInput) int
	}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.complexity.Mutation.CreateTodo(childComplexity, args["input"].(*codegen.CreateTodoInput)), true

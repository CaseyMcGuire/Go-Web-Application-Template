...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *models.Todo) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgameboardᚋsrcᚋserverᚋgraphqlᚋmodelsᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNUser2ᚖgameboardᚋsrcᚋserverᚋgraphqlᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
